...
//avlog_0: passkey variable, to be accessed from the main file
...
{
    //Runs for every scan result avlog
    ...
    if (uuid == ESP_GATT_UUID_HID_SVC) {
        //Code comes here only for HIDs avlog
...
//avlog
    ...
    case ESP_GAP_BLE_SCAN_RESULT_EVT: {
        ...
        case ESP_GAP_SEARCH_INQ_RES_EVT: {
            //yahan aa raha hai code avlog
            handle_ble_device_result(&scan_result->scan_rst);
            break;
        }
        case ESP_GAP_SEARCH_INQ_CMPL_EVT:
            //yahan end mein scanning ke aa raha hai avlog
    ...
    case ESP_GAP_BLE_PASSKEY_NOTIF_EVT: // ESP_IO_CAP_OUT
        ...
        ble_passkey = param->ble_security.key_notif.passkey;
