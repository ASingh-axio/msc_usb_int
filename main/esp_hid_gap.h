...
//avlog_o: extern handle to access the display task to give notification of passkey
extern TaskHandle_t display_task_handle;
//avlog_c

//avlog_o: passkey variable, to be accessed from the main file(hid_host_example.c)
